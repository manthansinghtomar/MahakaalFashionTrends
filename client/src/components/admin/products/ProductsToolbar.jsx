...
export const ProductsToolbar = ({
  ...
  return (
    <div className="bg-white border border-neutral-100 rounded-2xl p-4 sm:p-5 shadow-xs space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-between lg:gap-6 w-full min-w-0">
      ...
      <div className="grid grid-cols-1 sm:flex sm:flex-wrap items-center gap-3 lg:justify-end w-full lg:w-auto">
        {/* Category filter */}
        <select
        ...
        <button
          ...
          className="w-full sm:w-auto px-5 py-2.5 bg-neutral-950 text-white hover:bg-neutral-900 border border-neutral-950 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2"
        >
