    ...
    <div className="group relative bg-white p-6 sm:p-8 rounded-xl border border-neutral-200/60 hover:border-secondary/20 shadow-xs transition-all duration-300 flex flex-col justify-between space-y-6">
      ...
      <div className="space-y-4">
        ...
        <h3 className="text-xl font-bold tracking-tight text-neutral-900">
          Visit Mahakaal Fashion Trends
        </h3>

        <p className="text-sm text-neutral-500 leading-relaxed">
          Visit our store in Birla Nagar, Gwalior to explore a wide range of men's and kids' clothing. From casual wear and formal shirts to jeans, T-shirts, lower, belts, and accessories, we offer quality fashion at affordable prices.
        </p>
        ...
        <div className="p-4 bg-neutral-50 rounded-lg border border-neutral-100 space-y-2 text-xs sm:text-sm text-neutral-700">
          ...
          <p className="text-neutral-400 text-xs">Landmark: In Front of Mata Mandir Line no.1</p>
        </div>
      </div>
